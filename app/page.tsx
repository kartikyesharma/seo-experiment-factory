...
const faqs = [
  ...
  ["Can I request hotel or cab help here?", "You may leave an enquiry using the travel help form. It is not a confirmed booking, and no arrangement exists until a provider gives you written terms that you accept."],
...
export default function Home() {
  ...
  return <>
    ...
    <section className="hero home-hero">
      ...
      <p className="lede">Practical Somnath planning in one place: official-source checks, timings, ticket questions, nearby stays, transport, simple itineraries, and printable PDF guides.</p>
    ...
    <section className="quick-nav" aria-labelledby="quick-nav-title">
      <h2 id="quick-nav-title">What do you need help with?</h2>
      <nav>
        <Link href="#official-website">Official website check</Link>
        <Link href="#darshan-timings">Darshan timings</Link>
        <Link href="#ticket-caution">Ticket/payment caution</Link>
        <Link href="#hotels-near-temple">Hotels near Somnath temple</Link>
        <Link href="#reach-somnath">How to reach Somnath</Link>
        <TrackedLink href="#pdf-guides" event="pdf_cta_click">Download PDF checklist</TrackedLink>
      </nav>
    </section>
    ...
    <section id="pdf-guides" className="home-section wide-section product-band">
      <div className="section-heading"><div><p className="eyebrow">Printable planning aids</p><h2>Somnath PDF Guides</h2></div><p>Optional planning PDFs for travellers who prefer a compact offline checklist. These are independent guides, not official publications or booking documents; verify final details before payment.</p></div>
    ...
    <section id="official-website" className="home-section prose-section">
    ...
    <section id="darshan-timings" className="home-section split-section">
    ...
    <section id="ticket-caution" className="home-section prose-section">
    ...
    <section id="hotels-near-temple" className="home-section split-section reverse-split">
    ...
    <section id="reach-somnath" className="home-section prose-section">
    ...
    <section className="home-section hinglish-section">
      ...
      <div className="hinglish-grid">
        ...
        <div><h3>Somnath mandir official website</h3><p>Somnath mandir official website dhoondhte waqt poora domain check karein. Trust ke current portal se hi timing, notice aur listed service verify karein; sirf search title dekhkar payment na karein.</p></div>
    ...
    <section id="travel-help" className="home-section assistance-section">
      <div><p className="eyebrow">Optional travel enquiry</p><h2>Hotel or Cab Help</h2><p>Share your trip details and we can follow up about available hotel or cab options. This is only an enquiry—not a booking confirmation, room or cab reservation, or guarantee of any temple-related service.</p></div>
